...
import { Modal, Form, Input, Button, Row, Col, Card, message, Spin, Alert, Divider, Slider } from 'antd';
import { SettingOutlined, EyeOutlined, SaveOutlined, ArrowLeftOutlined } from '@ant-design/icons';
