...
class ImageTransformer:
    ...
    def __init__(self):
        professional_logger.info("operations", "Initializing ImageTransformer service", "transformer_init", {
        ...
        professional_logger.info("operations", "Central config parameters loaded successfully", "config_loaded", {
        ...
        try:
            ...
            if preset_resolution != 'custom':
                ...
                try:
                    ...
                    professional_logger.info("operations", f"Using preset resolution: {preset_resolution}", "resize_preset", {
                    ...
                    professional_logger.warning("operations", f"Failed to parse preset resolution, using fallback", "resize_preset_fallback", {
                        'preset': preset_resolution,
    ...
    def _apply_color_jitter(self, image: Image.Image, params: Dict[str, Any]) -> Image.Image:
        ...
        try:
            ...
            if hue_factor != 0:
                professional_logger.info("operations", f"Applying hue shift in color jitter", "color_jitter_hue", {
                    'hue_shift': hue_shift,
            ...
            if brightness_factor != 1.0:
                professional_logger.info("operations", f"Applying brightness variation in color jitter", "color_jitter_brightness", {
            ...
            if contrast_factor != 1.0:
                professional_logger.info("operations", f"Applying contrast variation in color jitter", "color_jitter_contrast", {
            ...
            if saturation_factor != 1.0:
                professional_logger.info("operations", f"Applying saturation variation in color jitter", "color_jitter_saturation", {
    ...
    def _apply_random_zoom(self, image: Image.Image, params: Dict[str, Any]) -> Image.Image:
        ...
        try:
            ...
            professional_logger.info("operations", f"Applying random zoom transformation", "zoom_start", {
                'original_size': f"{original_size[0]}x{original_size[1]}",
            ...
            if zoom_factor == 1.0:
                professional_logger.info("operations", f"Random zoom skipped (zoom_factor = 1.0)", "zoom_skipped", {
                    'zoom_factor': zoom_factor,
            ...
            professional_logger.info("operations", f"Random zoom transformation completed", "zoom_success", {
                'original_size': f"{original_size[0]}x{original_size[1]}",
                'final_size': f"{result.size[0]}x{result.size[1]}",
                'zoom_factor': zoom_factor,
                'zoom_type': zoom_type
    ...
    def _apply_affine_transform(self, image: Image.Image, params: Dict[str, Any]) -> Image.Image:
        ...
        try:
            ...
            professional_logger.info("operations", f"Applying affine transformation", "affine_start", {
                'original_size': f"{original_size[0]}x{original_size[1]}",
                'params': params
            })
            ...
            if rotation_angle != 0:
                professional_logger.info("operations", f"Applying rotation in affine transform", "affine_rotation", {
            ...
            if scale_factor != 1.0:
                professional_logger.info("operations", f"Applying scaling in affine transform", "affine_scaling", {
            ...
            if shift_x_factor != 0 or shift_y_factor != 0:
                professional_logger.info("operations", f"Applying shifts in affine transform", "affine_shifts", {
            ...
            professional_logger.info("operations", f"Affine transformation completed", "affine_success", {
                'original_size': f"{original_size[0]}x{original_size[1]}",
                'final_size': f"{result.size[0]}x{result.size[1]}",
                'rotation_angle': rotation_angle,
                'scale_factor': scale_factor,
    ...
    def _apply_perspective_warp(self, image: Image.Image, params: Dict[str, Any]) -> Image.Image:
        ...
        try:
            ...
            professional_logger.info("operations", f"Applying perspective warp transformation", "perspective_start", {
                'original_size': f"{original_size[0]}x{original_size[1]}",
            ...
            if distortion == 0:
                professional_logger.info("operations", f"Perspective warp skipped (distortion = 0)", "perspective_skipped", {
            ...
            professional_logger.info("operations", f"Perspective warp transformation completed", "perspective_success", {
                'original_size': f"{original_size[0]}x{original_size[1]}",
                'final_size': f"{result.size[0]}x{result.size[1]}",
                'distortion_strength': distortion_strength,
    ...
    def _apply_gamma_correction(self, image: Image.Image, params: Dict[str, Any]) -> Image.Image:
        ...
        try:
            ...
            professional_logger.info("operations", f"Applying gamma correction transformation", "gamma_start", {
                'original_size': f"{original_size[0]}x{original_size[1]}",
                'gamma': gamma,
                'params': params
            })
            ...
            if gamma == 1.0:
                professional_logger.info("operations", f"Gamma correction skipped (gamma = 1.0)", "gamma_skipped", {
                    'gamma': gamma,
                    'reason': 'gamma = 1.0'
                })
                return image
            ...
            professional_logger.info("operations", f"Gamma correction transformation completed", "gamma_success", {
                'original_size': f"{original_size[0]}x{original_size[1]}",
                'final_size': f"{result.size[0]}x{result.size[1]}",
                'gamma': gamma
            })
